...
class EdukasiGas extends StatefulWidget {
  const EdukasiGas({super.key});

  @override
  State<EdukasiGas> createState() => _EdukasiGasState();
}

class _EdukasiGasState extends State<EdukasiGas> {
  @override
